...
export const mcpOutlookJobDigestAuditMigration: Migration = {
  name: "mcp_outlook_job_digest_audit",
  version: 33,
  sql: `
    ...
    ALTER TABLE mcp_audit_events RENAME TO mcp_audit_events_version_thirty_two;
    ...
    SELECT
      id, workspace_id, actor_user_id, transport, action, target_type, result,
      occurred_at
    FROM mcp_audit_events_version_thirty_two;

    DROP TABLE mcp_audit_events_version_thirty_two;
