...
export const mcpJobPostingToolsAuditMigration: Migration = {
  name: "mcp_job_posting_tools_audit",
  version: 27,
  sql: `
    ...
    ALTER TABLE mcp_audit_events RENAME TO mcp_audit_events_version_twenty_six;
    ...
    SELECT
      id, workspace_id, actor_user_id, transport, action, target_type, result,
      occurred_at
    FROM mcp_audit_events_version_twenty_six;

    DROP TABLE mcp_audit_events_version_twenty_six;
