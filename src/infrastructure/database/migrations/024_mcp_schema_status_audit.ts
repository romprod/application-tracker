...
export const mcpSchemaStatusAuditMigration: Migration = {
  name: "mcp_schema_status_audit",
  version: 24,
  sql: `
    ...
    ALTER TABLE mcp_audit_events RENAME TO mcp_audit_events_version_twenty_three;
    ...
    SELECT
      id, workspace_id, actor_user_id, transport, action, target_type, result,
      occurred_at
    FROM mcp_audit_events_version_twenty_three;

    DROP TABLE mcp_audit_events_version_twenty_three;
