...
export const mcpOutlookEmailSyncAuditMigration: Migration = {
  name: "mcp_outlook_email_sync_audit",
  version: 29,
  sql: `
    ...
    ALTER TABLE mcp_audit_events RENAME TO mcp_audit_events_version_twenty_eight;
    ...
    SELECT
      id, workspace_id, actor_user_id, transport, action, target_type, result,
      occurred_at
    FROM mcp_audit_events_version_twenty_eight;

    DROP TABLE mcp_audit_events_version_twenty_eight;
