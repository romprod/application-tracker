...
export const mcpReconciliationToolsAuditMigration: Migration = {
  name: "mcp_reconciliation_tools_audit",
  version: 28,
  sql: `
    ...
    ALTER TABLE mcp_audit_events RENAME TO mcp_audit_events_version_twenty_seven;
    ...
    SELECT
      id, workspace_id, actor_user_id, transport, action, target_type, result,
      occurred_at
    FROM mcp_audit_events_version_twenty_seven;

    DROP TABLE mcp_audit_events_version_twenty_seven;
