...
export const mcpBulkApplicationUpdateAuditMigration: Migration = {
  name: "mcp_bulk_application_update_audit",
  version: 23,
  sql: `
    ...
    ALTER TABLE mcp_audit_events RENAME TO mcp_audit_events_version_twenty_two;
    ...
    SELECT
      id, workspace_id, actor_user_id, transport, action, target_type, result,
      occurred_at
    FROM mcp_audit_events_version_twenty_two;

    DROP TABLE mcp_audit_events_version_twenty_two;
