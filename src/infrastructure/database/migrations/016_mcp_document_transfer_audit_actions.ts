...
export const mcpDocumentTransferAuditActionsMigration: Migration = {
  name: "mcp_document_transfer_audit_actions",
  version: 16,
  sql: `
    ...
    ALTER TABLE mcp_audit_events RENAME TO mcp_audit_events_version_fifteen;
    ...
    SELECT
      id, workspace_id, actor_user_id, transport, action, target_type, result,
      occurred_at
    FROM mcp_audit_events_version_fifteen;

    DROP TABLE mcp_audit_events_version_fifteen;
